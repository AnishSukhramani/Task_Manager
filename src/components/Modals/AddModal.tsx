	...
	return (
		...
		>
			<div
				...
				onClick={closeModal}
			></div>
			<div className="md:w-[30vw] w-[90%] bg-black rounded-lg shadow-md z-50 flex flex-col items-center gap-3 px-5 py-6">
				<input
					type="text"
					name="title"
				...
				<button
					className="w-full mt-3 rounded-md h-9 bg-green-400 text-black font-medium"
